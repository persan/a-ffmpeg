...
package FFMpeg.log is
  ...
  --/< not part of ABI/API
   ...
   AV_CLASS_CATEGORY_NB : constant AVClassCategory := 46;
  ...
  --
   ...
   type AVClass is record
      ...
      item_name : access function  (arg1 : System.Address) return String;
      option : access constant FFMpeg.Low_Level.ffmpeg_libavutil_opt_h.AVOption;
      version : aliased int;
      log_level_offset_offset : aliased int;
      parent_log_context_offset : aliased int;
      child_next : access function  (arg1 : System.Address; arg2 : System.Address) return System.Address;
      child_class_next : access function  (arg1 : access constant AVClass) return access constant AVClass;
      category : aliased AVClassCategory;
      get_category : access function  (arg1 : System.Address) return AVClassCategory;
   ...
   pragma Convention (C_Pass_By_Copy, AVClass);
  ...
  --
   ...
   function default_item_name (ctx : System.Address) return String;


   function default_get_category (ptr : System.Address) return AVClassCategory;
  ...
  --
   ...
   function format_line2
     (ptr : System.Address;
      ...
      line : Interfaces.C.Strings.chars_ptr;
      line_size : int;
      print_prefix : access int) return int;
  ...
  --
   ...
   procedure set_flags (arg : int);


   function get_flags return int;
